...
scml_memory_operations< unsigned int >::
scml_memory_operations() :
  scml_memory_operations_podt_common< unsigned int >()
{
}
...
scml_memory_operations( value_type a ) :
  scml_memory_operations_podt_common< unsigned int >( a)
{
}
...
scml_memory_operations( const char * n ) :
  scml_memory_operations_podt_common< unsigned int >( n)
{
}
...
scml_memory_operations( const char * n,
			scml_memsize a ) :
  scml_memory_operations_podt_common< unsigned int >( n, a )
{
}
...
scml_memory_operations( scml_memory_operations & a, 
  ...
  scml_memory_operations_podt_common< unsigned int >( a, offset, size )
{
}
...
scml_memory_operations( const char * n,
			...
			size_type offset, size_type size ) :
  scml_memory_operations_podt_common< unsigned int >( n, a, offset, size )
{
}
