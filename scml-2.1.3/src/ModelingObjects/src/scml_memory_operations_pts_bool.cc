...
scml_memory_operations< bool >::
scml_memory_operations() :
  scml_memory_operations_podt_common< bool >()
{
}
...
scml_memory_operations( value_type a ) :
  scml_memory_operations_podt_common< bool >( a)
{
}
...
scml_memory_operations( const char * n ) :
  scml_memory_operations_podt_common< bool >( n)
{
}
...
scml_memory_operations( const char * n,
			scml_memsize a ) :
  scml_memory_operations_podt_common< bool >( n, a )
{
}
...
scml_memory_operations( scml_memory_operations & a, 
  ...
  scml_memory_operations_podt_common< bool >( a, offset, size )
{
}
...
scml_memory_operations( const char * n,
			...
			size_type offset, size_type size ) :
  scml_memory_operations_podt_common< bool >( n, a, offset, size )
{
}
