...
scml_memory_operations< signed short int >::
scml_memory_operations() :
  scml_memory_operations_podt_common< signed short int >()
{
}
...
scml_memory_operations( value_type a ) :
  scml_memory_operations_podt_common< signed short int >( a)
{
}
...
scml_memory_operations( const char * n ) :
  scml_memory_operations_podt_common< signed short int >( n)
{
}
...
scml_memory_operations( const char * n,
			scml_memsize a ) :
  scml_memory_operations_podt_common< signed short int >( n, a )
{
}
...
scml_memory_operations( scml_memory_operations & a, 
  ...
  scml_memory_operations_podt_common< signed short int >( a, offset, size )
{
}
...
scml_memory_operations( const char * n,
			...
			size_type offset, size_type size ) :
  scml_memory_operations_podt_common< signed short int >( n, a, offset, size )
{
}
...
scml_memory_operations< signed short int >::
getRegisterValueInt16(int16 & result, uint64 elementIndex)
{
...
scml_memory_base::ErrorCode
scml_memory_operations< signed short int >::
setRegisterValueInt16(int16 result, uint64 elementIndex)
{
  size_type i( elementIndex );
  if( !isValidIndex( i)) {
    return scml_memory_base::errorInvalidIndex;
...
scml_memory_base::ErrorCode
scml_memory_operations< signed short int >::
getRegisterValueVecInt16(::std::vector< int16 > & result,
			 uint64 elementIndex,
			 uint32 elementCount)
{
  size_type i( elementIndex );
