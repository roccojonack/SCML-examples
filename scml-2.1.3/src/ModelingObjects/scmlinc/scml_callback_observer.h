 ...
 *                                                                           *
 *****************************************************************************/
#ifndef SCML_CALLBACK_OBSERVER_H
#define SCML_CALLBACK_OBSERVER_H
...
{
public:
  scml_callback_observer(scml_callback_observer_owner* owner,
                         scml::AccessType t,
                         scml::AccessMode m);
  virtual ~scml_callback_observer();
  ...
  scml_callback_observer_owner* get_owner() const;

private:
  scml::AccessType mAccessType;
  scml::AccessMode mAccessMode;
  scml_callback_observer_owner* mOwner;
};

inline
scml_callback_observer::
scml_callback_observer(scml_callback_observer_owner *owner,
                  scml::AccessType t,
                  scml::AccessMode m) :
  mAccessType(t),
