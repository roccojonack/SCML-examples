 ...
 *                                                                           *
 *****************************************************************************/
#ifndef SCML2_BITFIELD_UNTIMED_MASK_WRITE_ADAPTER_H
#define SCML2_BITFIELD_UNTIMED_MASK_WRITE_ADAPTER_H
...
class bitfield_untimed_mask_write_adapter
{
public:
  typedef bool (C::*CallbackType)(const DT& value, const DT& bitMask);

public:
  bitfield_untimed_mask_write_adapter(C& c, CallbackType cb);
