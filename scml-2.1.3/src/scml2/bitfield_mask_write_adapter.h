 ...
 *                                                                           *
 *****************************************************************************/
#ifndef SCML2_BITFIELD_MASK_WRITE_ADAPTER_H
#define SCML2_BITFIELD_MASK_WRITE_ADAPTER_H
...
class bitfield_mask_write_adapter
{
public:
...
public:
  bitfield_mask_write_adapter(C& c, CallbackType cb);
