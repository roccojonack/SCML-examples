...
#ifndef SCML_MEMORY_OPERATIONS_PTS_UNSIGNED_CHAR_H
#define SCML_MEMORY_OPERATIONS_PTS_UNSIGNED_CHAR_H
...
template< > 
class scml_memory_operations< unsigned char > : 
  public scml_memory_operations_podt_common< unsigned char >
{
public:
...
public:
  ...
  virtual const char * getDocumentation() const { return "Uint8 Memory";}
...
inline scml_memory_operations< unsigned char >::this_reference_type
scml_memory_operations< unsigned char >::operator= ( value_type a )
{
  put( a);
  return *this;
}
