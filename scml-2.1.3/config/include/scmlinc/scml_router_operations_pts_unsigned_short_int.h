...
#ifndef SCML_ROUTER_OPERATIONS_PTS_UNSIGNED_SHORT_INT_H
#define SCML_ROUTER_OPERATIONS_PTS_UNSIGNED_SHORT_INT_H
...
template< > 
class scml_router_operations< unsigned short int > : 
  public scml_router_operations_podt_common< unsigned short int >
{
public:
...
public:
  ...
  virtual const char * getDocumentation() const { return "UInt16 Router";}
