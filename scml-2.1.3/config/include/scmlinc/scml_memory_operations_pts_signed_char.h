...
#ifndef SCML_MEMORY_OPERATIONS_PTS_SIGNED_CHAR_H
#define SCML_MEMORY_OPERATIONS_PTS_SIGNED_CHAR_H
...
template< > 
class scml_memory_operations< signed char > : 
  public scml_memory_operations_podt_common< signed char >
{
public:
...
public:
  ...
  virtual TypeID getType() const { return MEM_TYPE_INT8; }
  virtual bool isWriteable() const { return true; }
  virtual const char * getDocumentation() const { return "Int8 Memory";}
...
inline scml_memory_operations< signed char >::this_reference_type
scml_memory_operations< signed char >::operator= ( value_type a )
{
  put( a);
  return *this;
}
