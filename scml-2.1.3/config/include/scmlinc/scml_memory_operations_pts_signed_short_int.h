...
#ifndef SCML_MEMORY_OPERATIONS_PTS_SIGNED_SHORT_INT_H
#define SCML_MEMORY_OPERATIONS_PTS_SIGNED_SHORT_INT_H
...
template< > 
class scml_memory_operations< signed short int > : 
  public scml_memory_operations_podt_common< signed short int >
{
public:
  typedef signed short int value_type;
...
public:
  ...
  virtual TypeID getType() const { return MEM_TYPE_INT16; }
  virtual bool isWriteable() const { return true; }
  virtual const char * getDocumentation() const { return "Int16 Memory";}
  
  // virtual getter setter for instrumentation
  virtual ErrorCode getRegisterValueInt16( int16 & result,
					   uint64 elementIndex = 0);
  virtual ErrorCode setRegisterValueInt16( int16 result,
					   uint64 elementIndex = 0);
...
inline scml_memory_operations< signed short >::this_reference_type
scml_memory_operations< signed short >::operator= ( value_type a )
{
  put( a);
  return *this;
}
