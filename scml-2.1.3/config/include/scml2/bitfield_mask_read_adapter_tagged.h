 ...
 *                                                                           *
 *****************************************************************************/
#ifndef SCML2_BITFIELD_MASK_READ_ADAPTER_TAGGED_H
#define SCML2_BITFIELD_MASK_READ_ADAPTER_TAGGED_H
...
class bitfield_mask_read_adapter_tagged
{
public:
...
public:
  bitfield_mask_read_adapter_tagged(C& c, CallbackType cb, int id);
