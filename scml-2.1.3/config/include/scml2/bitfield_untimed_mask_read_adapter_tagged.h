 ...
 *                                                                           *
 *****************************************************************************/
#ifndef SCML2_BITFIELD_UNTIMED_MASK_READ_ADAPTER_TAGGED_H
#define SCML2_BITFIELD_UNTIMED_MASK_READ_ADAPTER_TAGGED_H
...
class bitfield_untimed_mask_read_adapter_tagged
{
public:
  typedef bool (C::*CallbackType)(DT& value, const DT& bitMask, int id);

public:
  bitfield_untimed_mask_read_adapter_tagged(C& c, CallbackType cb, int id);
...
template <typename DT, typename C>
inline
bitfield_untimed_mask_read_adapter_tagged<DT, C>
create_bitfield_read_adapter(C& c,
                             typename bitfield_untimed_mask_read_adapter_tagged<DT, C>::CallbackType cb,
                             int id)
{
  return bitfield_untimed_mask_read_adapter_tagged<DT, C>(c, cb, id);
}
