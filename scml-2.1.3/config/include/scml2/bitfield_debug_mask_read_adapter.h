 ...
 *                                                                           *
 *****************************************************************************/
#ifndef SCML2_BITFIELD_DEBUG_MASK_READ_ADAPTER_H
#define SCML2_BITFIELD_DEBUG_MASK_READ_ADAPTER_H
...
class bitfield_debug_mask_read_adapter
{
public:
  typedef bool (C::*CallbackType)(DT& value, const DT& bitMask);

public:
  bitfield_debug_mask_read_adapter(C& c, CallbackType cb);
