...
class word_read_extensions_adapter : public word_adapter_base
{
public:
...
public:
  word_read_extensions_adapter(C& c, CallbackType cb, const M& mem);
...
create_word_read_adapter(C& c,
                         ...
                         const M& mem)
{
  return word_read_extensions_adapter<M, C>(c, cb, mem);
}
