 ...
 *                                                                           *
 *****************************************************************************/
#ifndef SCML2_BITFIELD_DEBUG_MASK_WRITE_ADAPTER_TAGGED_H
#define SCML2_BITFIELD_DEBUG_MASK_WRITE_ADAPTER_TAGGED_H
...
class bitfield_debug_mask_write_adapter_tagged
{
public:
  typedef bool (C::*CallbackType)(const DT& value, const DT& bitMask, int id);

public:
  bitfield_debug_mask_write_adapter_tagged(C& c, CallbackType cb, int id);
